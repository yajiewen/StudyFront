...
<!--中间部分      -->
      <template v-slot:middle>
        ...
        <recharge v-on:getnewinfo="getnewmyinfo" v-show="middle_show.showrecharge"></recharge>
...
<!--右边部分      -->
      <template v-slot:right>
        ...
        <sendorderinfo v-on:changeshow="changeisshowwinfo" v-on:refreshsorders="refreshsendorders" v-bind:workerinfo="teacherinfo" v-on:gettinfo="getteacherinfo" v-bind:is_show_winfo="right_show.showteacherinfo" v-bind:order_info="send_order_info" v-show="right_show.showsendorderinfo"></sendorderinfo>
...
/*          this.is_show_log_button = false
    ...
    changeisshowwinfo(){
      this.right_show.showteacherinfo = !this.right_show.showteacherinfo
    },
    //获取takeorder信息
